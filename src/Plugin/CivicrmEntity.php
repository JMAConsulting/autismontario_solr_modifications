 ...
 * )
 */
class CivicrmEntity extends DatasourcePluginBase implements EntityDatasourceInterface, PluginFormInterface {
    ...
    public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
        ...
        if ($this->isTranslatable()) {
            ...
            $form['languages']['default'] = [
                '#type' => 'radios',
                '#title' => $this->t('Which languages should be indexedbbb?'),
                '#options' => [
                    0 => $this->t('Only those selected'),
                    1 => $this->t('All except those selected'),
                ],
